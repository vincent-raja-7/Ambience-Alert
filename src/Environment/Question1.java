...
public class Question1 extends  javax.swing.JFrame {
    ...
    public static final String f1="src\\Sounds\\fact1.mp3";
    MP3Player fact1=new MP3Player(new File(f1));
    /**
    ...
    private void initComponents() {
        ...
        getContentPane().add(X, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 0, -1, -1));

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/TV.png"))); // NOI18N
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 850, -1));

        getAccessibleContext().setAccessibleName("\t\t\tCrucial Facts");
